...
function dz_rev_slider_1() {
  ...
  if (dzQuery("#dz_rev_slider_1").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_1")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_2() {
  ...
  if (dzQuery("#dz_rev_slider_2").revolution == undefined) {
    ...
    dzrevapi = jQuery("#dz_rev_slider_2")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_3() {
  ...
  if (dzQuery("#dz_rev_slider_3").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_3")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_4() {
  ...
  if (dzQuery("#dz_rev_slider_3").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_4")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_5() {
  ...
  if (dzQuery("#dz_rev_slider_5").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_5")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_6() {
  ...
  if (dzQuery("#dz_rev_slider_6").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_6")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_7() {
  ...
  if (dzQuery("#dz_rev_slider_7").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_7")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_8() {
  ...
  if (dzQuery("#dz_rev_slider_8").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_8")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_9() {
  ...
  if (dzQuery("#dz_rev_slider_9").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_9")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
...
function dz_rev_slider_10() {
  ...
  if (dzQuery("#dz_rev_slider_10").revolution == undefined) {
    ...
    dzrevapi = dzQuery("#dz_rev_slider_10")
      .show()
      .revolution({
        sliderType: "standard",
        jsFileLocation:
